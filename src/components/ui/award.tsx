...
export function Awards({
    ...
    if (variant === "award") {
        const LaurelWreath = () => (
            <svg
                className={cn(
                    "fill-primary absolute top-1/2 h-full w-full -translate-y-1/2 opacity-20"
                )}
                width="892.77"
                height="688.08"
        ...
        return (
            <div
                className={cn(
                    ...
                    "overflow-hidden rounded-lg border border-white/10 bg-white/[0.02] backdrop-blur-sm",
                    "max-w-[240px]",
                    className
                )}
            >
                ...
                <div className="z-10 px-4 text-center">
                    <div
                        className={cn(
                            "mt-2 mb-2 inline-block rounded px-2 py-0.5 text-[8px] font-black tracking-[0.2em] text-white",
                    ...
                    <h1 className={cn("text-xs font-black tracking-tighter uppercase text-white")}>{title}</h1>
                    <div className="bg-white/10 mx-auto my-2 h-[1px] w-20"></div>
                    <h2 className={cn("mb-2 w-full text-[9px] font-medium leading-tight text-gray-400")}>{subtitle}</h2>

                    {recipient && (
                        <p className={cn("text-[7px] text-primary/60 italic mb-1")}>{recipient}</p>
                    )}

                    <div className={cn("text-[10px] font-black text-gray-500")}>{date}</div>
                </div>
            </div>
        )
    }
